...
export default function AdminLoginPage({ onLoginSuccess }) {
  ...
  return (
    <div className="min-h-screen bg-[#3d0006] text-white flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md bg-[#5d1016]/90 backdrop-blur-2xl rounded-3xl p-8 shadow-2xl border border-[#fed65b]/30">
        ...
        <div className="text-center mb-8">
          <img
            src={truckLogo}
            alt="TRUCK Logo"
            className="w-16 h-16 rounded-full object-cover mx-auto mb-4 border-2 border-[#fed65b] shadow-xl"
          />
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="bg-white/5 p-3 rounded-xl border border-white/10 text-[11px] text-[#ffb3b1]">
            <span className="font-bold text-[#fed65b]">Default Credentials:</span><br />
